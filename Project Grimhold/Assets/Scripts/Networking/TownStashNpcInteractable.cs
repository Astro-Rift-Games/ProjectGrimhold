...
/// <summary>
/// Social Town interaction endpoint for the local stash.
/// It only validates and confirms an interaction; stash state remains owned by
/// the local profile repository and is never mutated by this network object.
/// </summary>
[DisallowMultipleComponent]
[RequireComponent(typeof(NetworkObject))]
public sealed class TownStashNpcInteractable : NetworkBehaviour, IInteractable
{
    ...
    public override void Spawned()
    {
        ...
        if (!_isRegistered)
        {
            Debug.LogError($"{nameof(TownStashNpcInteractable)} requires an EntityRegistry.", this);
        }
    }
