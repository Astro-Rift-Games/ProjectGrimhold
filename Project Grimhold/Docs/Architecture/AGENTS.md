...
* Character identity.
* Attribute set and allocation rules.
...
* Build-side consequences of character progression, such as attribute points.
* Build persistence.
...
Defines the Game Design rules for persistent character progression through Experience and Levels, including the distinction between provisional Expedition XP and consolidated persistent XP.
...
* Separation between character statistics and equipment-owned properties.
