...
- **Migration Status**:
  ...
  **Important Distinctions**:
  ...
  - **Defeated Host remains Host**: The canonical Host is identified by the runner-scoped `RaidLaunchContext.HostProfileId`, not avatar or participant Input Authority. Its defeated avatar enters local spectator presentation, while its peer and runner remain State Authority. Return, Abandon and Cancel Raid are rejected; Host Migration remains reserved for actual Host peer loss.
